...
class ClicksInfo{
	...
	public function addClick() : void{
		...
		if($cps >= 21){
			$player->sendTitle(TextFormat::YELLOW . "Double Clicking is", TextFormat::BOLD . TextFormat::RED . "PROHIBITED" . TextFormat::RESET . TextFormat::YELLOW . ", Use DC Prevent (" . TextFormat::WHITE . "discord.gg/ezro" . TextFormat::YELLOW . ")", 5, 20, 5);
			if($cps >= 21){
				...
				if(++$this->flag > 50){
					...
					$theReason .= TextFormat::RED . "Kicked by " . TextFormat::DARK_GRAY . "» " . TextFormat::GRAY . "Ezro";
					$clientInfo = $session->getClientInfo();

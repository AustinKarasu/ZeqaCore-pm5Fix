...
class PracticeCore extends PluginBase{
	...
	const PROXY = false;
	const DEBUG = false;
	const COLOR = TextFormat::LIGHT_PURPLE;
	const PREFIX = self::COLOR . "Ezro" . TextFormat::DARK_GRAY . " » " . TextFormat::RESET;
	...
	protected function onEnable() : void{
		...
		$this->getServer()->getNetwork()->setName(TextFormat::BOLD . self::COLOR . "Ez" . TextFormat::WHITE . "ro");
	}

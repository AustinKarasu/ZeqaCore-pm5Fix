...
class DatabaseManager{
	...
	public static function initialize() : void{
		...
		self::$mainDB = libasynql::create(PracticeCore::getInstance(), $databaseInfo, ["mysql" => "mysql.sql"]);
		self::$extraDB = libasynql::create(PracticeCore::getInstance(), $databaseInfo, ["mysql" => "mysql.sql"]);
		...
		self::$mainDB->executeImplRaw([0 => "CREATE TABLE IF NOT EXISTS PlayerItems (xuid VARCHAR(16) NOT NULL UNIQUE, name TEXT, potcolor TEXT, projectile TEXT, tag TEXT, artifact TEXT, cape TEXT, killphrase TEXT, ownedprojectile TEXT, ownedtag TEXT, ownedartifact TEXT, ownedcape TEXT, ownedkillphrase TEXT, premium_bp INT, free_bp_progress INT, premium_bp_progress INT)"], [0 => []], [0 => SqlThread::MODE_GENERIC], function(){ }, null);
		...
		Curl::register(PracticeCore::getInstance());
